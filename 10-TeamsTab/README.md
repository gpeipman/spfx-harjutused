...
* [Build Microsoft Teams tab using SharePoint Framework - Tutorial](https://learn.microsoft.com/et-ee/sharepoint/dev/spfx/web-parts/get-started/using-web-part-as-ms-teams-tab)
